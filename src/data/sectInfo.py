sectList = ["Autarch Flipping", "Explosion", "Blank",
            "Thousand and One Petals", "Debauchery Tea Party"]  # Name of Sect
sectCall = ["ELON", "Exp", "Blank", "PETALS",
            "TeaParty"]  # call for .!sect <name>
sectTags = ["「 ELON 」", "Explosion", "『　　』",
            "《 PETALS 》", "[TeaParty]"]  # Tag required for xp
sectOwner = ["Perpetual Phoenix", "Megumin_Explosion", "Weiqing", "Ziyun",
             "ZaChan"]  # Owner of Sect
