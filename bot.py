...
sectList = ["Autarch Flipping", "Explosion","Blank","Thousand and One Petals","Debauchery Tea Party","Sort Post A Massege", "Rising Peak","NOT A GAE","The Cult of Myriad"] #Name of Sect
sectCall = ["ELON","Exp","Blank","PETALS","TeaParty","spam","Lord","gae","cult"] #call for .!sect <name>
sectTags = ["「 ELON 」","Explosion","『　　』","《 PETALS 》","[TeaParty]","[spam]","Lord","【GAE】","⧹Cult⧸"] #Tag required for xp   
sectOwner = ["Perpetual Phoenix", "Megumin_Explosion", "Weiqing","Ziyun","ZaChan","VANSTORM","Modsan","WitheringLeaf","Dew"] #Owner of Sect
