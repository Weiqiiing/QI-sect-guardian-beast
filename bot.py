...
sectList = ["Autarch Flipping", "Explosion","Blank","Thousand and One Petals","Debauchery Tea Party","Sort Post A Massege", "Rising Peak","NOT A GAE","Myriad ways to become a master of DAO"] #Name of Sect
sectCall = ["ELON","Exp","Blank","PETALS","TeaParty","spam","Lord","gae","torii"] #call for .!sect <name>
sectTags = ["「 ELON 」","Explosion","『　　』","《 PETALS 》","[TeaParty]","[spam]","Lord","【GAE】","〈ＴＯＲＩＩ〉"] #Tag required for xp   
